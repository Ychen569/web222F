function validate() {
  ...
  if(latitude < -90 || latitude > 90){
    document.getElementById("LatitudeError").innerHTML = "must be valid Latitude (-90 to 90)";
    return false;
  }

  if(longitude < -180 || longitude > 180){
    document.getElementById("LongitudeError").innerHTML = "must be valid Longitude (-180 to 180)";
    return false;
  }
